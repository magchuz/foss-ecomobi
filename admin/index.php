...
$setisi = '{
    ...
    "meta": "'.$_POST["meta"].'",
	"token": "'.$_POST["token"].'",
	"head": "'.trim(preg_replace('/\s+/', ' ', str_replace('"','\"',$_POST["head"]))).'",
	"body": "'.trim(preg_replace('/\s+/', ' ', str_replace('"','\"',$_POST["body"]))).'"
...
<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="container-fluid main-container">
		...
		<textarea type="text" class="form-control" rows="5" id="meta" name="meta" placeholder="Spintax Meta Description" required><?php echo($meta); ?></textarea>		<h4>Token EcoMobi</h4>
		<input type="text" class="form-control" id="token" name="token" placeholder="Token EcoMobi" value="<?php echo($token); ?>" required>		
		<h4>Head Tag Injector</h4>
		<textarea type="text" class="form-control" rows="5" id="head" name="head" placeholder="Head Code"><?php echo($head); ?></textarea>
		<h4>Body Tag Injector</h4>
		<textarea type="text" class="form-control" rows="5" id="body" name="body" placeholder="Body Code"><?php echo($body); ?></textarea>
</br>		
